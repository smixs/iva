...
- 📮 **Google Workspace** — Gmail, Календарь, Drive, Таблицы, Документы и Google Tasks прямо из чата через CLI `gws`; ставится сам, а подключение ключа проходите по шагам прямо в переписке.
