...
- **[22.07.2026] v0.2.6** 🧪 **Userbot для личного Telegram (бета)** - читает и отправляет от вашего *собственного* аккаунта, а не только от бота; онбординг целиком в чате (QR, без терминала), анти-бан защита (лимиты FloodWait, рандомизированный темп, circuit-breaker) включена на сервере принудительно. Включается вручную, на свой риск
