...
- **[23.07.2026] main** ⏹️ Управление на лету: `/stop` обрывает текущий ход прямо из чата, сообщения в занятое время встают в очередь вместо того, чтобы теряться, а у статуса «работаю» появился анимированный лоадер
