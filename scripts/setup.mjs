...
async function writeEnv(out) {
  const order = [
    "AGENT_LANGUAGE",
    "MODEL_PROVIDER",
    "OLLAMA_API_KEY", "OLLAMA_MODEL", "OLLAMA_MODEL_LADDER", "OLLAMA_CONTEXT_WINDOW",
    "OPENCODE_API_KEY", "OPENCODE_MODEL", "OPENCODE_MODEL_LADDER", "OPENCODE_CONTEXT_WINDOW",
    "OPENROUTER_API_KEY", "OPENROUTER_MODEL", "OPENROUTER_MODEL_LADDER", "OPENROUTER_CONTEXT_WINDOW",
